...
/**
 * @description
 * This spec file contains test to verify that admin can create an event when user uploads a file, custom file with custom text is also created
 *
 * @breadcrumb
...
describe('Login > {existing server} > events > create new event', () => {
  ...
  const customText = `this file ${customFileName} was created when ${remoteDirFile} was uploaded`
